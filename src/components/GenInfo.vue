      ...
      <v-card-text class="generation__container">
        <v-container>
            <div class="justify-center align-center">
                <div class="headline text-h5 text-capitalize font-weight-black text-center">Generations</div>
                <div class="subtitle-1 text-center">Use search for generations to explore your Pokémon!</div>
                <v-row>
                    <v-col
